...
// Provides control sap.ui.comp.P13nFilterPanelBase.
sap.ui.define([
	...
	'sap/m/P13nFilterPanelBaseRenderer',
	"sap/ui/core/Lib"
	...
	// shortcut for sap.ui.comp.P13nPanelType
	var P13nPanelType = library.P13nPanelType;

	// shortcut for sap.ui.comp.P13nConditionOperation
	...
	var P13nFilterPanelBase = P13nPanel.extend("sap.ui.comp.p13n.P13nFilterPanelBase", /** @lends sap.ui.comp.p13n.P13nFilterPanelBase.prototype */ {
		metadata: {
			...
			aggregations: {
				 ...
				 */
				filterItems: {
					type: "sap.ui.comp.P13nFilterItem",
					multiple: true,
		...
		renderer: P13nFilterPanelBaseRenderer.renderer
	});
	 ...
	 *
	 * @public
	 * @param {sap.ui.comp.P13nFilterPanelBase.FilterConditionOperations[]} aConditions the complete list of conditions
	 ...
	 *
	 * @public
	 * @returns {sap.ui.comp.P13nFilterPanelBase.FilterConditionOperations[]} array with filter conditions
	 */
