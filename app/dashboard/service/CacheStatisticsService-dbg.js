sap.ui.define(["sap/m/MessageBox", "sap/ui/model/odata/v4/ODataModel"], function (MessageBox, ODataModel) {
  "use strict";
  ...
  class CacheStatisticsService {
     ...
     */
    async getTopKeys(cacheName, limit = 10) {
      try {
     ...
     */
    async getColdKeys(cacheName, limit = 10) {
      try {
        const binding = this.model.bindList("/KeyMetrics", undefined, undefined, undefined, {
          $filter: `period eq 'current' and cache eq '${cacheName}'`,
     ...
     */
    async persistStatistics(cacheName) {
      try {
